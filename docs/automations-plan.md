...
| On/off | Each trigger has its own switch in the editor. The row switch pauses everything automatic: off means neither schedule nor webhook fires (webhook answers 503). Run now always works. |
