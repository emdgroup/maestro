                                    ...
                                    .is_err()
                                {
                                    ...
                                    for s in remaining {
                                        let _ = restore_state.app_handle.emit(
                                            &format!("acp://session-ended/{}", s.session_id),
                                            (),
                                        );
                                    }
