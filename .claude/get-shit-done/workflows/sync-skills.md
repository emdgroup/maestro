...
INSTALL_JS_GLOBAL="/home/m306213/workspace/maestro/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/m306213/workspace/maestro/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
