...
```bash
cp "/home/m306213/workspace/maestro/.claude/get-shit-done/USER-PROFILE.md" "/home/m306213/workspace/maestro/.claude/USER-PROFILE.backup.md"
```
...
```bash
BACKUP_PATH="/home/m306213/workspace/maestro/.claude/USER-PROFILE.backup.md"
```
