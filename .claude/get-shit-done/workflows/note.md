...
- **Global scope**: `/home/m306213/workspace/maestro/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/m306213/workspace/maestro/.claude/notes/`)
...
2. Glob `/home/m306213/workspace/maestro/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/m306213/workspace/maestro/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/m306213/workspace/maestro/.claude/notes/` — works in any directory
