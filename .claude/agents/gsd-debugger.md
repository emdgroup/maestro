...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/m306213/workspace/maestro/.claude
                  → checks /home/m306213/workspace/maestro/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/m306213/workspace/maestro/.claude/get-shit-done
                  → writes to /home/m306213/workspace/maestro/.claude/get-shit-done/hooks/
...
@/home/m306213/workspace/maestro/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @/home/m306213/workspace/maestro/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/home/m306213/workspace/maestro/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/m306213/workspace/maestro/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/m306213/workspace/maestro/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
