...
describe("NewWorktreeFields — the branch name", () => {
  ...
  it("says the name is generated when there is none to preview", () => {
    ...
    expect(input).toHaveAttribute("placeholder", "Auto-generated by default");
    // Prose, so it does not sit in the monospace a branch name is typed in.
    expect(input.className).toContain("placeholder:font-sans");
  });
