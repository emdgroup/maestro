...
export function TaskDetail({ task, projectPath, onClose }: TaskDetailProps) {
  ...
  return (
    <div className="fixed inset-0 bg-background/80 backdrop-blur-sm z-50 flex items-center justify-center p-4" onClick={(e) => {
          ...
          {activeTab === 'info' && (
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">{task.acceptance_criteria || 'No criteria'}</p>
              </div>
