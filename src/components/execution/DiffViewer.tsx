      ...
      {hunkCells.map((cell, idx) =>
        createPortal(
          <CheckboxPrimitive.Root
            ...
            className="hunk-checkbox border-border dark:bg-input/30 data-checked:bg-accent data-checked:text-foreground data-checked:border-foreground flex size-3.5 items-center justify-center rounded-[3px] border shadow-xs shrink-0 outline-none"
            tabIndex={-1}
          >
