...
/**
 * The second trigger: a URL that starts this automation when something calls it.
 *
...
export function WebhookSection({
  ...
  const on = automation.webhook_enabled;
      ...
      <div className="flex items-center gap-2">
        ...
        {!on && (
          <span className="text-[11px] text-muted-foreground">
            Also run when a service calls its URL
          </span>
        )}
      </div>
        ...
        <div className="space-y-3 rounded-md border border-border bg-muted/20 p-3">
          ...
          <div className="space-y-1">
            ...
            <p className="text-[11px] leading-relaxed text-muted-foreground/70">
              ...
              sends it as <code>Authorization: Bearer &lt;secret&gt;</code>. The request body is
              added below the prompt for the agent to read.
            </p>
          </div>
          ...
          <div className="space-y-1">
            ...
            <Select
              ...
              onValueChange={(value) =>
                value && onChange({ webhook_overlap: value as WebhookOverlap })
              }
            >
            ...
            {sharedDirectory && (
              <p className="flex items-start gap-1 text-[11px] text-amber-600">
                ...
                This automation does not get its own worktree per run, so runs alongside each other
                work in the same directory and can undo each other's changes.
              </p>
            )}
          </div>
