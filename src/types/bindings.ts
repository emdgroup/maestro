...
export const commands = {
  ...
  async createProject(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("create_project", { path, connectionId, wslConnectionId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async cloneProject(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("clone_project", { url, targetPath, connectionId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async createNewProject(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("create_new_project", { parentDir, folderName, connectionId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async removeTaskRelationship(relationshipId: number): Promise<Result<null, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("remove_task_relationship", { relationshipId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async approveTaskAndMerge(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("approve_task_and_merge", { taskId, mergeStrategy }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async preflightConnection(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("preflight_connection", { connectionId, wslConnectionId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async detectProjectAgents(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("detect_project_agents", { connectionId, wslConnectionId, cwd }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async discoverAgents(
    connectionId: number | null,
    wslConnectionId: number | null,
  ): Promise<Result<AgentDiscoveryResult, string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("discover_agents", { connectionId, wslConnectionId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async closeAcpSession(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("close_acp_session", {
          agentId,
          sessionId,
          cwd,
          connectionId,
  ...
  async addTaskAttachment(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("add_task_attachment", { taskId, filename, filePath, fileSize }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
