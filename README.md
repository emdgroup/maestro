...
| Linux — arm64                       | [Maestro_0.10.0_aarch64.AppImage](https://github.com/emdgroup/maestro/releases/latest/download/Maestro_0.10.0_aarch64.AppImage)           |
| Windows — x86_64                    | [Maestro_0.10.0_x64-setup.exe](https://github.com/emdgroup/maestro/releases/latest/download/Maestro_0.10.0_x64-setup.exe) ✓ recommended   |
| Windows — x86_64 (MSI)              | [Maestro_0.10.0_x64_en-US.msi](https://github.com/emdgroup/maestro/releases/latest/download/Maestro_0.10.0_x64_en-US.msi)                 |
