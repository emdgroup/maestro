...
| Platform                            | Download                                                                                                                                  |
| ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- |
| macOS — Apple Silicon (M1/M2/M3/M4) | [Maestro_0.11.2_aarch64.dmg](https://github.com/emdgroup/maestro/releases/latest/download/Maestro_0.11.2_aarch64.dmg)                     |
| Linux — x86_64                      | [Maestro_0.11.2_amd64.AppImage](https://github.com/emdgroup/maestro/releases/latest/download/Maestro_0.11.2_amd64.AppImage) ✓ recommended |
| Linux — x86_64 (no auto-update)     | [Maestro_0.11.2_amd64.deb](https://github.com/emdgroup/maestro/releases/latest/download/Maestro_0.11.2_amd64.deb)                         |
| Linux — arm64                       | [Maestro_0.11.2_aarch64.AppImage](https://github.com/emdgroup/maestro/releases/latest/download/Maestro_0.11.2_aarch64.AppImage)           |
| Windows — x86_64                    | [Maestro_0.11.2_x64-setup.exe](https://github.com/emdgroup/maestro/releases/latest/download/Maestro_0.11.2_x64-setup.exe) ✓ recommended   |
| Windows — x86_64 (MSI)              | [Maestro_0.11.2_x64_en-US.msi](https://github.com/emdgroup/maestro/releases/latest/download/Maestro_0.11.2_x64_en-US.msi)                 |
